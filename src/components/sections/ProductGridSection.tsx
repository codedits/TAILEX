...
/**
 * ProductGridSection - Server Component
 * 
 * Optimized for FCP/LCP:
 * - No "use client" - zero blocking JS
 * - CSS animations instead of Framer Motion
 * - Limits to 3 featured products initially
 * - All images lazy loaded (no priority)
 */
      ...
      >
        ...
        <div className="w-full px-6 md:px-10 py-24 md:py-[150px] flex flex-col gap-16 md:gap-20">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 w-full overflow-hidden border-b border-foreground/10 pb-12">
            {/* Title - Left */}
            <h2
              className="text-foreground whitespace-pre-line font-manrope font-black tracking-tight leading-[0.9] hero-text-animate"
              style={{
            ...
            {/* Description - Right */}
            <div className="md:w-1/3 hero-text-animate-delay">
              <p
          ...
          {/* Grid - 3 columns with stagger animation */}
