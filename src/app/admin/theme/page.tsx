                ...
                <div className="grid gap-10">
                    ...
                    <Card className="bg-[#0A0A0A] border-white/10 rounded-2xl overflow-hidden shadow-2xl">
                        ...
                        <CardContent className="grid md:grid-cols-2 gap-8 p-8">
                            <div className="space-y-2">
                                <Label htmlFor="primaryColor" className="text-white/60 text-xs font-medium uppercase tracking-widest pl-1">Primary (Buttons & Accents)</Label>
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="backgroundColor" className="text-white/60 text-xs font-medium uppercase tracking-widest pl-1">Background (Main Page)</Label>
                                <div className="flex gap-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="foregroundColor" className="text-white/60 text-xs font-medium uppercase tracking-widest pl-1">Text (Primary Font)</Label>
                                <div className="flex gap-4">
